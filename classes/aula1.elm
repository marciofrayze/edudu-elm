...
------- 6- O que é o "circle"?
-- A lista de formas geométricas pode ter circulos,
-- retangulos, hexagonos entre muitas outras formas.
-- No nosso exemplo, utilizamos um circulo (circle
-- em inglês). Para desenharmos um circulo precisamos
-- informar 2 PARÂMETROS:
-- O primeiro parâmetro representa sua cor. No nosso
-- exemplo, usamos a cor verde (green).
-- O segundo parâmetro indica o tamanho do circulo.
...
-- Altere o valor do tamanho do circulo para um
-- número que quiser.
...
-- circulo. Tente adicionar um segundo circulo de
-- outra cor e um pouco menor que o primeiro.
-- Dicas:
--     - Lembre-se que os simbolos [ e ] indicam uma
--       lista. Então o segundo circulo deve estar
--       dentro desses simbolos.
--     - Utilize uma virgula para indicar que quer
--       criar um segundo circulo dentro da lista de
--       formas geométricas.
--     - Cuidado com a ordem! Se o circulo menor ficar
...
-- devem ser 4 circulos, um dentro do outro, com
